...
Опциональное правило, которое меняет – когда выдаются карты "Архитектуры".

Изменения:
- Возьмите необходимо количество карт "Архитектура" по числу игроков
- Вместо раздачи карт сразу, карты выбираются игроком, когда он выложил свой первый компонент на стол. Первый игрок всегда имеет выбор из всех доступных карт "Архитектур", второй – на одну меньше, и так далее
