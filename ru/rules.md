...
Кстати, если вы вернули свой компонент со стола в руку, то такой компонент находится в 🚧 блоке:
- он лежит у вас в руке рубашкой к вам и лицом к другим игрокам, чтобы они все видели, какой *вид компонента* заблокирован
- сыграть такой *вид компонента* (например, все карты вида "Фронтенд") сможете только через указанное количество ходов (пока его чинят ваши инженеры!)
...
Некоторые карты имеют специальное условие в нижней трети карты о том, что нужно сделать при розыгрыше. Игроку *необходимо* выполнить данный социальный ритуал до своего следующего действия в данном ходу. Если игрок забыл, не может или не хочет его выполнять, то, первый заметивший игрок может выдернуть у него из руки случайную карту. 🚧 Заблокированные карты забирать очень просто, потому что вы видите, что забираете.
...
- Сдаете всегда по 5 в самом начале
