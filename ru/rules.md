...
### Как работает карта "Специфическая ошибка" при наличии карты "Мониторинг"?

Мониторинг имеет приоритет. То есть: даже карта "Специфическая ошибка" может атаковать только "Мониторинг".
