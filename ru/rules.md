...
И прямо как в настоящей жизни, нужно душить и отменять своих коллег, мониторить свою инфраструктуру и не деплоить в пятницу, воровать, ДДоСить и ронять чужие приложения. С нешуточными последствиями!
...
Например: карта "Хайп" позволяет взять:
- 2 карты из колоды, если у вас нет компонентов на столе
- ⚙️3 карты из колоды, если у вас есть компонент на столе
