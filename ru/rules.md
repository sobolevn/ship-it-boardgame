...
- С дополнительными правилами по духоте. Тогда тянуть карту можно за любой косяк. Например: нельзя просто так трогать облако, пока оно лежит на столе (а то вдруг его незаметно развернут?); долго тупить во время своего хода; недостаточно отыгрывать социальный ритуал (не слишком драматичная "Отмена", не слишком токсичное "Выгорание"); неправильно указывать на несовершение социального ритуала (когда игрок его сделал или не должен был делать); игрок сделал вид, что у него нет "Легаси" при событии "Пятница", хотя "Легаси" было. И любые другие правила, которые вы найдете достаточно душными и веселыми для вашей компании.
