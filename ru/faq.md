...
## Как работает карта "Legacy"?

Карту "Legacy" нельзя прямо сыграть
или сбросить с руки (например при превышении предела карт).
Если вы взяли ее из колоды, то она просто лежит у вас в руке.
Если вы получили данную карту от другого игрока (любым способом:
при использовании карты "Cherrypick", "OpenSource", "P2P"
или просто при выдергивании карты из руки), то вы обязаны выполнить ее условие.
