...
Пока разыгрываются события – выкладывать новые карты, например: "CI" и "Сертификат" – нельзя. Только играть реакции и пользоваться теми, которые уже лежат. Если есть.
