...
Если атаку перевели на атакующего, то он может разыгрывать только карты защитной реакции ("Отговорка" / "Патч" / "Новый релиз") и "sudo" до конца атаки. То есть: нельзя сыграть, скажем, карты "Добор" и только потом вернуться к защите.
...
Игрок, против которого сыграли "Выгорание", не сможет сыграть никакие новые карты (кроме "Отмены") или взять карты, если он еще не успел. Однако, карты которые он уже взял / сыграл – остаются как были.
