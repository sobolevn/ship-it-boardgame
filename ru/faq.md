...
Некоторые компоненты можно (если на них есть сответсвующая надпись), можно скидывать взамен на новые карты из колоды. В данном случае все равно можно играть только один компонент за ход. Нельзя скинуть два, нельзя скинуть и выложить за один ход.
