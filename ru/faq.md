...
Карты "Мониторинг" / "Файрвол" провоцируют все атаки на себя.

У Алисы на столе лежат компоненты "Бекенд" и "Мониторинг". Борис атакует Алису картой "Специфическая Ошибка".

Особенность данной ситуации в том, что карта "Мониторинг" защищает все другие компоненты от ошибок (кроме себя). Следовательно, Борис может атаковать только компонент "Мониторинг".

Ни Борис, ни Алиса не могут выбирать компонент для атаки в данной ситуации. Даже если под другими компонентами есть карты "CI", и Алисе было бы удобно защититься другой картой.
...
Пока разыгрываются события – выкладывать новые карты – нельзя. Только играть реакции и пользоваться теми, которые уже лежат. Если есть.
...
**Вариант игры**: если вам слишком много социальности – можно играть без данной карты!
...
Социальное взаимодействие можно доиграть после "Выгорания", если вас нагло перебили. Если в игре есть "Manual" с действием в конце хода – вы должны выполнить его.
...
Аналогично, если у игрока был "DDoS", розыгрыш дополнительного "Выгорания" не оставит его еще на один ход. "DDoS" сбрасывается.
...
**Вариант игры**: можно играть с картами "Выгорания" на руках с раздачи. Дает больше хаоса и увеличивает время игры.
...
Данная карта позволяет забрать себе в руку у другого игрока карту, которую он только что взял сам себе в руку. Если игрок берет несколько карт, то тогда нужно забрать последнюю / верхнюю карту. Берегите(сь) "Легаси"!

С картой "Handshake" оба игрока берут карты. Последней картой считается верхняя карта, полученная при обмене игроком, который разыграл карту "Handshake".
...
Если вы получили данную карту от другого игрока (любым способом: при использовании карты "Handshake", "OpenSource", "P2P", "Man in the Middle" или просто при выдергивании карты из руки), то вы обязаны выполнить ее условие.

Данную карту нельзя скинуть. Никак. Даже если у вас на руке только одна карта "Легаси" и вам необходимо скинуть карту от "Хакерских лапок" или от другого полученного "Легаси".
