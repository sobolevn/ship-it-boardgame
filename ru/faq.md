...
![простая атака](https://raw.githubusercontent.com/sobolevn/ship-it-boardgame/master/ru/schemas/atack2.jpg)
...
## Как работает карта "DDoS"?

При розыгрыше карты DDoS имеет смысл положить ее на стол игроку, которому вы запрещаете выкладывать компоненты в следующий ход. Иначе, можно забыть о ней!

![ddos](https://raw.githubusercontent.com/sobolevn/ship-it-boardgame/master/ru/schemas/ddos.jpg)

Сбросьте её, когда действие кончается.

## Как работает карта "Manual"?

Данная карта позволяет вносить новые социальные взаимодействия:
- Или в начале хода (до взятия карты)
- Или в конце хода (когда вы говорите, что завершили ход)

Если разыграть две такие карты, то можно сделать по одному новому правилу в начале или в конце хода. Или по одному для начала и конца.
